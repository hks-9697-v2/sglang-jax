...
class ModelRunner(ModelRunnerKVCacheMixin, BaseModelRunner):
    ...
    def adjust_layer_num(self):
        ...
        # Compute SWA vs full layer counts from hybrid_layer_pattern or layer_types
        ...
        swa_head_dim = getattr(self.model_config.hf_config, "swa_head_dim", self.model_config.head_dim)
        ratio = (swa_heads_per_device * swa_head_dim) / float(full_heads_per_device * self.model_config.head_dim)
