...
class ModelConfig:
    ...
    def needs_kv_head_replication(self, tensor_parallel_size: int) -> bool:
        ...
        if hasattr(self, "_original_swa_num_key_value_heads"):
            return tensor_parallel_size > self._original_swa_num_key_value_heads or tensor_parallel_size > getattr(self, "_original_hf_num_key_value_heads", 1)
        total_num_kv_heads = self.get_total_num_kv_heads()
    ...
    def get_swa_weight_params(self):
        ...
        orig_full_heads = getattr(
            self, "_original_hf_num_key_value_heads", getattr(self, "_original_num_key_value_heads", 4)
        )
        ...
        return cfg.head_dim, getattr(cfg, "swa_head_dim", cfg.head_dim), orig_swa_heads, orig_full_heads, target_heads
